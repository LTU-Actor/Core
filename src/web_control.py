...
web_env['ACTOR_DBW_ENABLE_VEHICLE'] = str(rospy.get_param('~vehicle_enable', '/vehicle/enable'))
...
web_env['LIDAR_FRONT_CLOSEST'] = str(rospy.get_param('~lidar_front_closest', '/region/front_closest'))
web_env['LIDAR_RIGHT_CLOSEST'] = str(rospy.get_param('~lidar_right_closest', '/region/right_closest'))
web_env['LIDAR_LEFT_CLOSEST'] = str(rospy.get_param('~lidar_left_closest', '/region/left_closest'))
